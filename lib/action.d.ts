...
export declare type DeepActionHelpers<TReducers extends Reducers, TEffects extends Effects<any, any, any, any, any, any>, TModels extends Models> = ActionHelpers<TReducers> & ActionHelpers<TEffects> & ModelsActionHelpers<TModels> & {
    $namespace: string;
    $parent: unknown;
    $root: unknown;
};
