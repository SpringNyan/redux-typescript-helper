...
export interface DeepGettersChild<TModels extends Models, TDynamicModels extends Models> {
    <K extends Extract<keyof ModelsGetters<TModels>, string>>(namespace: K): ModelsGetters<TModels>[K];
    <K extends Extract<keyof ModelsGetters<TDynamicModels>, string>>(namespace: K): ModelsGetters<TDynamicModels>[K] | null;
}
...
export declare function createModelGetters<TDependencies, TModel extends Model<TDependencies>>(model: TModel, dependencies: StoreHelperDependencies<TDependencies>, getState: () => unknown, namespaces: string[], parent: ModelGetters<Model<TDependencies>> | null): ModelGetters<TModel>;
