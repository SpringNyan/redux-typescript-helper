...
var StoreHelperFactory = /** @class */ (function () {
    function StoreHelperFactory(model, dependencies, options) {
        ...
        this._getters = createModelGetters(this._model, this._dependencies, function () { return _this._store.getState(); }, [], null);
        var initialEpic = createModelEpic(model, this._dependencies, this._options.epicErrorHandler || null, this._actions, this._getters, []);
    ...
    StoreHelperFactory.prototype.create = function (store) {
        ...
        this._store = store;
        var storeHelper = new _StoreHelper(this._store, this._model, this._dependencies, this._options, this._actions, this._getters, this._addEpic$, []);
...
var _StoreHelper = /** @class */ (function () {
    function _StoreHelper(store, model, dependencies, options, actions, getters, addEpic$, namespaces) {
    ...
    _StoreHelper.prototype.registerModel = function (namespace, model) {
        ...
        this._getters[namespace] = createModelGetters(model, this._dependencies, function () { return _this._store.getState(); }, namespaces, this._getters);
        this._addEpic$.next(createModelEpic(model, this._dependencies, this._options.epicErrorHandler || null, this._actions.$root, this._getters.$root, namespaces));
    ...
    _StoreHelper.prototype._registerSubStoreHelper = function (namespace) {
        var _this = this;
        this._subStoreHelpers[namespace] = new _StoreHelper(this._store, this._model.models[namespace], this._dependencies, this._options, this._actions[namespace], this._getters[namespace], this._addEpic$, this._namespaces.concat([namespace]));
