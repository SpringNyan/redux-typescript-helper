...
var StoreHelper = /** @class */ (function () {
    ...
    StoreHelper.prototype.namespace = function (namespace) {
        return new StoreHelper(this._store, this._model.models[namespace], this._namespaces.concat([namespace]), this._actions[namespace], this._getters[namespace], this._rootGetters, this._addEpic$, this._dependencies);
    };
