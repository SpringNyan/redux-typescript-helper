...
function createModelActionHelpers(model, namespaces, parent) {
    var actions = {
        ...
        $parent: parent,
        $register: createActionHelper(namespaces.concat([actionTypes.register]).join("/")),
        $epicEnd: createActionHelper(namespaces.concat([actionTypes.epicEnd]).join("/")),
        $unregister: createActionHelper(namespaces.concat([actionTypes.unregister]).join("/"))
    };
