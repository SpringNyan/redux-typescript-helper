...
var StoreHelper = /** @class */ (function () {
    function StoreHelper(store, model, namespaces, actions, getters, rootGetters, addEpic$, dependencies) {
    ...
    StoreHelper.prototype.registerModel = function (namespace, model) {
        ...
        this._addEpic$.next(createModelEpic(model, namespaces, this.actions[namespace], this.getters[namespace], this._dependencies));
    ...
    StoreHelper.prototype._registerSubStoreHelper = function (namespace) {
        var _this = this;
        this._subStoreHelpers[namespace] = new StoreHelper(this._store, this._model.models[namespace], this._namespaces.concat([namespace]), this._actions[namespace], this._getters[namespace], this._rootGetters, this._addEpic$, this._dependencies);
...
var StoreHelperFactory = /** @class */ (function () {
    function StoreHelperFactory(model, dependencies) {
        ...
        var initialEpic = createModelEpic(model, [], this._actions, this._getters, dependencies);
    ...
    StoreHelperFactory.prototype.create = function (store) {
        ...
        this._store = store;
        return new StoreHelper(store, this._model, [], this._actions, this._getters, this._getters, this._addEpic$, this._dependencies);
    };
