...
import { createModelEpic, createModelActionDispatchers } from "./epic";
...
var StoreHelperFactory = /** @class */ (function () {
    function StoreHelperFactory(dependencies, model, options) {
        ...
        this._dispatchers = createModelActionDispatchers(this._model, this._dependencies, [], null);
        this._storeHelper = new _StoreHelper(this._model, this._dependencies, this._options, this._actions, this._getters, this._dispatchers, function (epic) { return _this._addEpic$.next(epic); }, [], null);
...
export function createStoreHelperFactory(dependencies, model, options) {
    if (options == null) {
        options = {};
    }
...
var _StoreHelper = /** @class */ (function () {
    function _StoreHelper(model, dependencies, options, actions, getters, dispatchers, addEpic, namespaces, parent) {
    ...
    Object.defineProperty(_StoreHelper.prototype, "dispatch", {
        get: function () {
    ...
    _StoreHelper.prototype._registerSubStoreHelper = function (namespace) {
        var _this = this;
        this._subStoreHelpers[namespace] = new _StoreHelper(this._model.models[namespace], this._dependencies, this._options, this._actions[namespace], this._getters[namespace], this._dispatchers[namespace], this._addEpic, this._namespaces.concat([namespace]), this);
