...
export function registerModelEpics(model, namespaces, rootActions, rootGetters, rootAction$, rootState$, dependencies) {
    var outputs = [];
...
export function createModelRootEpic(model, namespaces, actions, getters, dependencies, options) {
