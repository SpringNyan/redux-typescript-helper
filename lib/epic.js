...
function invokeModelEpics(model, dependencies, rootAction$, rootState$, namespaces) {
    ...
    var getHelper = function () {
        return getIn(dependencies.$storeHelper, namespaces, function (obj, key) { return obj.$child(key); });
    };
    var getActions = function () { return getHelper().actions; };
    var getGetters = function () { return getHelper().getters; };
